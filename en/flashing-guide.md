...
![VMware USB Setting 1](/images/flash-vmware-usb-1.png)

![VMware USB Setting 2](/images/flash-vmware-usb-2.png)
...
![FC REC Jumper Short](/images/flash-recovery-jumper.jpg)

![Recovery Mode Detected](/images/flash-recovery-detected.png)
...
![Cancel Host Machine](/images/flash-sdk-cancel-host.png)

2. Select only **Jetson Linux**

![Select Jetson Linux](/images/flash-sdk-jetson-linux.png)

### 1.4 Wait for Download

![Downloading](/images/flash-downloading.png)

### 1.5 Configure Flashing Parameters

**Pre-Config**: Pre-set username and password

![Pre-Config](/images/flash-preconfig.png)

**Runtime**: Configure username and password after boot

![Runtime](/images/flash-runtime.png)

**Storage Device**: Select the target medium (SD card / NVMe SSD / USB drive)

![Storage Device Selection](/images/flash-storage-device.png)

Select **Developer Kit Version**:

![Select DevKit Version](/images/flash-devkit-version.png)

![Flashing in Progress](/images/flash-sdk-flashing.png)

![Flashing Complete](/images/flash-sdk-done.png)
...
![Command-Line Flashing](/images/flash-cli-flashing.png)
...
![SUPER Mode Verification](/images/flash-super-mode-verify.png)
