...
![VMware USB 设置 1](/images/flash-vmware-usb-1.png)

![VMware USB 设置 2](/images/flash-vmware-usb-2.png)
...
![FC REC 跳线短接](/images/flash-recovery-jumper.jpg)

![恢复模式已检测到](/images/flash-recovery-detected.png)
...
![取消 Host Machine](/images/flash-sdk-cancel-host.png)

2. 只勾选 **Jetson Linux**

![只勾选 Jetson Linux](/images/flash-sdk-jetson-linux.png)

### 1.4 等待下载完成

![等待下载中](/images/flash-downloading.png)
...
![存储设备选择](/images/flash-storage-device.png)

选择 **Developer Kit Version**：

![选择 Developer Kit 版本](/images/flash-devkit-version.png)

![刷机进行中](/images/flash-sdk-flashing.png)

![刷机完成](/images/flash-sdk-done.png)
...
![命令行刷机中](/images/flash-cli-flashing.png)
...
![SUPER 模式验证](/images/flash-super-mode-verify.png)
